...
public class xoxoyunu {
    ...
    public static void main(String[] args) {
        ...
        String oyuncu="x";
        System.out.println("OYUNUMUZA HOŞGELİDNİZ");
        tasarımıyazdır(oyuntasarımı);
        while(true) {
            String yazdir="";
            Scanner tara= new Scanner(System.in);
            System.out.println("1-9 ARSASİNDA SAYİ GİRİSİ YAPİNİZ...");
            ...
            while (oyunucu1pozisyonu.contains(pozisyon)||oyunucu2pozisyonu.contains(pozisyon)){
                System.out.println("KOYMAK İSTEDGİNİZ YER DOLU LUTFEN BOSLUK OLAN BİR YERE KOYMAYİ DENEYİN...");
                pozisyon= tara.nextInt();
            }
    ...
    static String satırıkontrolet()  {
        ...
        for (List l:kazanmaşartları){
            if (oyunucu1pozisyonu.containsAll(l)){
                return "KAZANAN OYUNCU 1 OLDU TEBRİKLER";
            } else if (oyunucu2pozisyonu.containsAll(l)) {
                return "KAZANAN OYUNCU 2 OLDU TEBRİKLER";
            } else if (count==5) {
                return "DOSTLUK KAZANDI BERABERE BİTTİ";
